            ...
            <div class="invoice-header text-center text-md-start">
                <div class="d-flex flex-column flex-md-row justify-content-between align-items-center">
                    ...
                    <div class="mt-3 mt-md-0 text-white">
                        ...
                        <p class="mb-0"><i class="fas fa-info-circle me-2"></i> Status: <span
                                class="badge bg-success">Lunas</span></p>
                    </div>
                </div>
            </div>
            ...
            <div class="invoice-body">
                <div class="row mb-4">
                    <div class="col-md-6">
                        ...
                        <p class="text-muted mb-0"><i class="fas fa-clock me-2"></i> Dibuat pada:
                            {{ date('d M Y H:i') }}
                        </p>
                    </div>
